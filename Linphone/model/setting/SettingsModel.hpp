...
public:
	...
	DECLARE_GETSET(bool, recordingUploadEnabled, RecordingUploadEnabled)
	DECLARE_GETSET(QString, recordingUploadUrl, RecordingUploadUrl)
	DECLARE_GETSET(QString, recordingUploadToken, RecordingUploadToken)
